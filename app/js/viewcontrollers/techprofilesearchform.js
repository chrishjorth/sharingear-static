...
define(
	...
	function($, _, ViewController, GoogleMaps, App, Moment, Utilities, Localization) {
		var numberOfTechProfileSuggestions = 5,
			geocoder,
		...
		didRender = function() {
            ...
            new GoogleMaps.places.Autocomplete($('#techprofilesearch-location', view.$element)[0], {types: ['geocode']});
		...
		handleDeliveryDate = function(event) {
			...
			if(deliveryInputString !== '') {
				passedData = {
					pickupDate: $('#techprofilesearch-pickup', view.$element).val(),
