...
define(
	['underscore', 'jquery', 'viewcontroller', 'app', 'models/van', 'models/localization', 'googlemaps','utilities', 'moment'],
	function(_, $, ViewController, App, Van, Localization, GoogleMaps, Utilities, Moment) {
		var geocoder,
